...
let FmGripperGoal = require('./FmGripperGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class FmGripperActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = FmGripperGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FmGripperActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = FmGripperGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new FmGripperGoal()
    }
...
module.exports = FmGripperActionGoal;
